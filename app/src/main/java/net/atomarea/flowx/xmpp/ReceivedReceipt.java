 ...
 */
public class ReceivedReceipt implements ExtensionElement {

    public static final String NAMESPACE = "urn:xmpp:fx:received";
    public static final String ELEMENT = "received";

    private String id;

    public ReceivedReceipt(String id) {
        this.id = id;
    }
    ...
    public static class Provider extends EmbeddedExtensionProvider<ExtensionElement> {
        ...
        protected ExtensionElement createReturnExtension(String currentElement, String currentNamespace, Map attributeMap, List content) {
            return new ReceivedReceipt(String.valueOf(attributeMap.get("id")));
        }
    }
}