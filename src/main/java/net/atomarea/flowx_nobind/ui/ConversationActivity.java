...
import net.atomarea.flowx_nobind.services.XmppConnectionService.OnAccountUpdate;
import net.atomarea.flowx_nobind.services.XmppConnectionService.OnConversationUpdate;
import net.atomarea.flowx_nobind.services.XmppConnectionService.OnRosterUpdate;
import net.atomarea.flowx_nobind.ui.adapter.ConversationAdapter;
...
public class ConversationActivity extends XmppActivity implements OnAccountUpdate, OnConversationUpdate, OnRosterUpdate, OnUpdateBlocklist, XmppConnectionService.OnShowErrorToast, View.OnClickListener {
    ...
    public static final String ACTION_DOWNLOAD = "net.atomarea.flowx_nobind.action.DOWNLOAD";
            ...
            public void onPresenceSelected() {
                ...
                switch (attachmentChoice) {
                    ...
                    case ATTACHMENT_CHOICE_RECORD_VOICE:
                        if (Build.VERSION.SDK_INT >= 23) {
                            ...
                            if (hasMicPerm == PackageManager.PERMISSION_GRANTED) {
                                ...
                                intent.setPackage("net.atomarea.flowx_nobind");
                            } else
                    ...
                    case ATTACHMENT_CHOICE_LOCATION:
                        intent.setAction("net.atomarea.flowx_nobind.location.request");
                        intent.setPackage("net.atomarea.flowx_nobind");
                        break;
                }
    ...
    protected void attachFileDialog() {
        ...
        if (!(new Intent("net.atomarea.flowx_nobind.location.request").resolveActivity(getPackageManager()) == null)) {
