...
import net.atomarea.flowx_nobind.entities.Presences;
import net.atomarea.flowx_nobind.services.AvatarService;
import net.atomarea.flowx_nobind.services.XmppConnectionService;
import net.atomarea.flowx_nobind.services.XmppConnectionService.XmppConnectionBinder;
import net.atomarea.flowx_nobind.ui.widget.Switch;
			...
			nfcAdapter.setNdefPushMessageCallback(new NfcAdapter.CreateNdefMessageCallback() {
				...
				public NdefMessage createNdefMessage(NfcEvent nfcEvent) {
					return new NdefMessage(new NdefRecord[]{
							...
							NdefRecord.createApplicationRecord("net.atomarea.flowx_nobind")
					});
				}
			}, this);
		}
