...
import net.atomarea.flowx_nobind.parser.AbstractParser;
...
import net.atomarea.flowx_nobind.crypto.PgpEngine;
import net.atomarea.flowx_nobind.crypto.axolotl.AxolotlService;
import net.atomarea.flowx_nobind.crypto.axolotl.XmppAxolotlMessage;
import net.atomarea.flowx_nobind.entities.Account;
import net.atomarea.flowx_nobind.entities.Blockable;
import net.atomarea.flowx_nobind.entities.Bookmark;
...
import net.atomarea.flowx_nobind.entities.MucOptions;
import net.atomarea.flowx_nobind.entities.MucOptions.OnRenameListener;
import net.atomarea.flowx_nobind.entities.Presence;
import net.atomarea.flowx_nobind.entities.PresenceTemplate;
import net.atomarea.flowx_nobind.entities.Roster;
import net.atomarea.flowx_nobind.entities.ServiceDiscoveryResult;
import net.atomarea.flowx_nobind.entities.Transferable;
import net.atomarea.flowx_nobind.entities.TransferablePlaceholder;
import net.atomarea.flowx_nobind.generator.IqGenerator;
import net.atomarea.flowx_nobind.generator.MessageGenerator;
import net.atomarea.flowx_nobind.generator.PresenceGenerator;
import net.atomarea.flowx_nobind.http.HttpConnectionManager;
import net.atomarea.flowx_nobind.parser.IqParser;
import net.atomarea.flowx_nobind.parser.MessageParser;
import net.atomarea.flowx_nobind.parser.PresenceParser;
import net.atomarea.flowx_nobind.persistance.DatabaseBackend;
import net.atomarea.flowx_nobind.persistance.FileBackend;
import net.atomarea.flowx_nobind.ui.UiCallback;
import net.atomarea.flowx_nobind.utils.CryptoHelper;
import net.atomarea.flowx_nobind.utils.ExceptionHelper;
import net.atomarea.flowx_nobind.utils.OnPhoneContactsLoadedListener;
import net.atomarea.flowx_nobind.utils.PRNGFixes;
import net.atomarea.flowx_nobind.utils.PhoneHelper;
import net.atomarea.flowx_nobind.utils.SerialSingleThreadExecutor;
import net.atomarea.flowx_nobind.utils.Xmlns;
import net.atomarea.flowx_nobind.xml.Element;
import net.atomarea.flowx_nobind.xmpp.OnBindListener;
import net.atomarea.flowx_nobind.xmpp.OnContactStatusChanged;
import net.atomarea.flowx_nobind.xmpp.OnIqPacketReceived;
import net.atomarea.flowx_nobind.xmpp.OnKeyStatusUpdated;
import net.atomarea.flowx_nobind.xmpp.OnMessageAcknowledged;
import net.atomarea.flowx_nobind.xmpp.OnMessagePacketReceived;
import net.atomarea.flowx_nobind.xmpp.OnPresencePacketReceived;
import net.atomarea.flowx_nobind.xmpp.OnStatusChanged;
import net.atomarea.flowx_nobind.xmpp.OnUpdateBlocklist;
import net.atomarea.flowx_nobind.xmpp.XmppConnection;
import net.atomarea.flowx_nobind.xmpp.chatstate.ChatState;
import net.atomarea.flowx_nobind.xmpp.forms.Data;
import net.atomarea.flowx_nobind.xmpp.forms.Field;
import net.atomarea.flowx_nobind.xmpp.jid.InvalidJidException;
import net.atomarea.flowx_nobind.xmpp.jid.Jid;
import net.atomarea.flowx_nobind.xmpp.jingle.JingleConnectionManager;
import net.atomarea.flowx_nobind.xmpp.jingle.OnJinglePacketReceived;
...
public class XmppConnectionService extends Service implements OnPhoneContactsLoadedListener {
    ...
    public boolean saveEncryptedMessages() {
        return !getPreferences().getBoolean("dont_save_encrypted", true);
    }
