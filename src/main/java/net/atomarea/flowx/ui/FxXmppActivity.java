...
public abstract class FxXmppActivity extends AppCompatActivity {
    ...
    protected Runnable onOpenPGPKeyPublished = new Runnable() {
        @Override
        public void run() {
            Toast.makeText(FxXmppActivity.this, R.string.openpgp_has_been_published, Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private UiCallback<Conversation> adhocCallback = new UiCallback<Conversation>() {
        ...
        public void success(final Conversation conversation) {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(FxXmppActivity.this, R.string.conference_created, Toast.LENGTH_LONG).show();
                }
            });
        }
        ...
        public void error(final int errorCode, Conversation object) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(FxXmppActivity.this, errorCode, Toast.LENGTH_LONG).show();
                }
            });
        }
        ...
        builder.setNeutralButton(getString(R.string.restart),
                new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        stopService(new Intent(FxXmppActivity.this,
    ...
    public static class ConferenceInvite {
        ...
        public void execute(FxXmppActivity activity) {
